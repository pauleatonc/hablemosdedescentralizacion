...
class Noticias(TimeStampedModel):
    titulo_noticia = models.CharField(max_length=200 ,verbose_name='Titulo Noticia (obligatorio)', unique=True)
    ...
    tag_noticia = models.ManyToManyField(
...
class Multimedia(TimeStampedModel):
    ...
    video_url = models.URLField(max_length=200, null=True,
                            blank=True, verbose_name='Url video Youtube (obligatorio)')
    tag_media = models.ManyToManyField(
            Tag, blank=False, verbose_name='Tag noticia')
